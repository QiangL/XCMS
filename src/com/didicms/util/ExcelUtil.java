...
public class ExcelUtil {
	static class Inner{
		...
		public Inner(Connection conn,PreparedStatement pstmt){this.conn=conn;this.pstmt=pstmt;}
		public Inner(){};
	...
	private static void executeAccount(Workbook workbook) throws SQLException{
		String sql="insert into account(account_id,account_password,account_company_id)"
				+ "values(?,?,?)";
		Inner inner=new Inner();
